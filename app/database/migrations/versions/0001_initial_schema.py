...
def upgrade() -> None:
    ...
    wallet_status = sa.Enum("active", "frozen", "closed", name="wallet_status")
    plan_status = sa.Enum("draft", "active", "paused", "archived", name="plan_status")
    investment_status = sa.Enum(
        "pending", "active", "completed", "cancelled", name="investment_status"
    )
    deposit_status = sa.Enum(
        "detected", "confirmed", "credited", "rejected", name="deposit_status"
    )
    ...
    transaction_status = sa.Enum(
        "pending", "posted", "voided", name="transaction_status"
    )
    referral_status = sa.Enum("pending", "paid", "reversed", name="referral_status")
    ...
    op.create_table(
        ...
        sa.Column(
            "network", sa.String(length=32), server_default="BSC", nullable=False
        ),
        sa.Column("minimum_amount", sa.Numeric(38, 18), nullable=False),
        sa.Column("maximum_amount", sa.Numeric(38, 18), nullable=True),
        ...
        sa.Column("status", plan_status, server_default="draft", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "available_balance", sa.Numeric(38, 18), server_default="0", nullable=False
        ),
        sa.Column(
            "reserved_balance", sa.Numeric(38, 18), server_default="0", nullable=False
        ),
        sa.Column("deposit_address", sa.String(length=128), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "profit_amount", sa.Numeric(38, 18), server_default="0", nullable=False
        ),
        sa.Column(
            "paid_profit_amount", sa.Numeric(38, 18), server_default="0", nullable=False
        ),
        sa.Column(
            "status", investment_status, server_default="pending", nullable=False
        ),
        ...
        sa.CheckConstraint(
            "profit_amount >= 0", name="ck_investments_profit_nonnegative"
        ),
        sa.CheckConstraint(
        ...
        sa.ForeignKeyConstraint(
            ["plan_id"], ["investment_plans.id"], ondelete="RESTRICT"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index("ix_investments_user_status", "investments", ["user_id", "status"])
    op.create_index(
        "ix_investments_next_accrual_at", "investments", ["next_accrual_at"]
    )
    ...
    op.create_table(
        ...
        sa.Column("status", deposit_status, server_default="detected", nullable=False),
        sa.Column(
            "detected_at",
            sa.DateTime(timezone=True),
            server_default=sa.func.now(),
    ...
    op.create_index(
        "ix_deposits_status_detected_at", "deposits", ["status", "detected_at"]
    )
    ...
    op.create_table(
        ...
        sa.Column("amount", sa.Numeric(38, 18), nullable=False),
        sa.Column("fee", sa.Numeric(38, 18), server_default="0", nullable=False),
        sa.Column(
            "status", withdrawal_status, server_default="requested", nullable=False
        ),
        ...
        sa.CheckConstraint("fee >= 0", name="ck_withdrawals_fee_nonnegative"),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="RESTRICT"),
        sa.ForeignKeyConstraint(["wallet_id"], ["wallets.id"], ondelete="RESTRICT"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        "ix_withdrawals_status_requested_at", "withdrawals", ["status", "requested_at"]
    )
    ...
    op.create_table(
        ...
        sa.Column("asset", sa.String(length=16), server_default="USDT", nullable=False),
        sa.Column("amount", sa.Numeric(38, 18), nullable=False),
        sa.Column("balance_before", sa.Numeric(38, 18), nullable=False),
    ...
    op.create_index(
        "ix_transactions_wallet_created_at", "transactions", ["wallet_id", "created_at"]
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column("source_investment_id", sa.Uuid(), nullable=True),
        sa.Column("level", sa.Integer(), server_default="1", nullable=False),
        sa.Column("reward_percent", sa.Numeric(12, 8), nullable=False),
        sa.Column("reward_amount", sa.Numeric(38, 18), nullable=False),
        ...
        sa.CheckConstraint("level > 0", name="ck_referral_rewards_level_positive"),
        sa.CheckConstraint(
        ...
        sa.ForeignKeyConstraint(
            ["referred_user_id"], ["users.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["source_investment_id"], ["investments.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "referrer_id",
    ...
    op.create_index(
        "ix_audit_logs_actor_created_at", "audit_logs", ["actor_user_id", "created_at"]
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "last_scanned_block", sa.Integer(), server_default="0", nullable=False
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
...
def downgrade() -> None:
    op.drop_index(
        "ix_blockchain_scan_states_next_block", table_name="blockchain_scan_states"
    )
    ...
    op.drop_index("ix_referral_rewards_referrer_status", table_name="referral_rewards")
    op.drop_table("referral_rewards")
    op.drop_index("ix_transactions_user_type_created_at", table_name="transactions")
    ...
    op.drop_index("ix_withdrawals_status_requested_at", table_name="withdrawals")
    op.drop_table("withdrawals")
    op.drop_index("ix_deposits_user_status", table_name="deposits")
    op.drop_index("ix_deposits_status_detected_at", table_name="deposits")
    op.drop_table("deposits")
    op.drop_index("ix_investments_next_accrual_at", table_name="investments")
    op.drop_index("ix_investments_user_status", table_name="investments")
    op.drop_table("investments")
    op.drop_index("ix_wallets_user_status", table_name="wallets")
    op.drop_table("wallets")
    op.drop_index(
        "ix_investment_plans_status_sort_order", table_name="investment_plans"
    )
